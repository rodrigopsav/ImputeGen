...
#-----------------------------#
"
mamba install -y -n imputegen -c conda-forge parallel 
...
#-----------------------------#
"
mamba install -y -n imputegen -c trent dos2unix 
...
#------------------------#
"
comambanda install -y -n imputegen -c anaconda git=2.28.0
...
#-----------------------------#
"
mamba install -y -n imputegen -c bioconda bedtools
...
#---------------------------#
"
mamba install -y -n imputegen -c bioconda vcflib
...
#--------------------------#
"
mamba install -y -n imputegen -c bioconda plink
mamba install -y -n imputegen -c bioconda plink2
...
#--------------------------#
"
#conda install -y -n imputegen -c soil eagle-phase
...
#-----------------------------#
"
mamba install -y -n imputegen -c bioconda shapeit4
...
#----------------------------#
"
mamba install -y -n imputegen -c bioconda impute2
...
#---------------------------#
"
#conda install -y -n imputegen -c bioconda beagle
...
#------------------------------#
"
mamba install -y -n imputegen -c bioconda admixture
...
#------------------------------#
"
mamba install -y -n imputegen -c bioconda structure
...
#----------------------------#
#"
mamba install -y -n imputegen -c anaconda openjdk
...
echo "####################################################################################"
echo "# TO RUN THESE PROGRAMS FOR OTHER APPLICATION, ACTIVATE NANOPORE CONDA ENVIRONMENT #"
