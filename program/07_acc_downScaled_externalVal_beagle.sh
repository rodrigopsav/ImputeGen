...
# R2 and MAF
paste -d "\t" $ACC/012/mapPred_"$FileExtension".txt $ACC/r2_maf/r2_"$FileExtension".txt $ACC/r2_maf/maf_"$FileExtension".txt > $ACC/r2_maf/r2_maf_"$FileExtension".txt
...
# 
# 
rm -r $ACC/stats/*"$FileExtension".log 2> /dev/null
rm -r $ACC/stats/*"$FileExtension".nosex 2> /dev/null
